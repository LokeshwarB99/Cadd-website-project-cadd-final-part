...
let contentContainer = $(".cadd-placement-all-jobs");
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            data.map(obj => {
                ...
                contentContainer.append(`<div class="cadd-placement-boxes">
                <div class="cadd-placement-box-flex">
                    <p>${obj.jobRole}</p>
                    <img src="/media/${obj.companyLogo}" alt="neolite" width="50px">
                </div>
                <div class="cadd-placement-loc">
                ...
                <div class="cadd-placement-sal-last">
                    <div class="cadd-placement-sal">
                    ...
                    <div class="cadd-placement-cadd-placement-last">
